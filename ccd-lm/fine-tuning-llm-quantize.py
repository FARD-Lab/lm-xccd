...
bnb_config = BitsAndBytesConfig(
    load_in_4bit=True,                 # flip to False + load_in_8bit=True for 8-bit
    bnb_4bit_use_double_quant=True,
    bnb_4bit_quant_type="nf4",         # most accurate 4-bit codebook
    bnb_4bit_compute_dtype=torch.bfloat16  # or torch.float16 on pre-Ampere GPUs
)
...
def main():
    ...
    base_model = prepare_model_for_kbit_training(
        base_model,
        use_gradient_checkpointing=True,   # you already planned on this
    )
