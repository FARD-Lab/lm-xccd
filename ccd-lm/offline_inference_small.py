...
tiktoken_cache_dir = pathlib.Path("..")/"tiktoken_cache"
...
class OfflineRequest:
    def __init__(self,  model="Phi-3-medium-128k-instruct", stream=False):
        self.model_path = pathlib.Path("../models") / model
...
# # ---------------------------------------------------------------------
def main():
    output = os.path.join(current_location, "offline_results", "python_java_results_small.jsonl")
